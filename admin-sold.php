          ...
          <ul class="nav flex-column ml-3 mb-5">
            ...
            <div class="col-md-11 p-5 pt-2">
                ...
                <table class="table">
                    <thead>
                    <tr>
                        <th scope="col">Product Sold ID</th>
                    ...
                    <?php $query = mysqli_query ($koneksi,"SELECT * from barang_terjual order by id_barang_terjual"); ?>
                        
                        <?php while ($data = mysqli_fetch_array($query)):?>

                        <tr>
                            <td><?php echo $data['id_barang_terjual']?></td>
